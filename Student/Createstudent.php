                ...
                <div class="write-post-container1">
                    <div class="student-account">
                        <ul>
                            ...
                            <div class="Student-box">
                                <li> First Name : </li>
                                <input id="studentFisrtName" name="studentFirstName" type="text" placeholder="Student FirstName" required="required">
                            </div>
                            <div class="Student-box">
                                <li> Name : </li>
                                <input id="studentName" name="studentLastName" type="text" placeholder="Student Name" required="required">
                            </div>
                            <div class="Student-box">
                                <li> Promotion : </li>
