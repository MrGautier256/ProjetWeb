                ...
                <div class="write-post-container1">
                    <div class="student-account">
                        <ul>
                            ...
                            <div class="Student-box">
                                <li> PassWord : </li>
                                <input id="myInput" name="pseudoPilotPassword" type="password" placeholder="Pilot Password" required="required">
                            </div>
                            <div class="Student-box">
                                <li> Confirm Password : </li>
                                <input id="myInput" name="pseudoPilotConfirmPassword" type="password" placeholder="Confirm Password" required="required">
                            </div>
