                ...
                <div class="write-post-container1">
                    <div class="student-account">
                        <ul>
                            ...
                            <div class="Student-box">
                                <li> First Name : </li>
                                <input id="myInput" name="pseudoDelegateFirstName" type="text" placeholder="Delegate FirstName" required="required">
                            </div>
                            <div class="Student-box">
                                <li> Name : </li>
                            ...
                            <div class="Student-box">
                                <li> PassWord : </li>
                                <input id="myInput" name="pseudoDelegatePassword" type="text" placeholder="Delegate Password" required="required">
                            </div>
                            <div class="Student-box">
                                <li> Confirm Password : </li>
                                <input id="myInput" name="pseudoDelegateConfirmPassword" type="text" placeholder="Confirm Password" required="required">
                            </div>
